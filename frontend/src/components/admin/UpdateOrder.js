...
export default function UpdateOrder () {
    ...
    const { user: user = {}, orderItems: orderItems = [], shippingInfo: shippingInfo = {}, totalPrice: totalPrice = 0, paymentInfo: paymentInfo = {}} = orderDetail;
                        ...
                        <div className="col-12 col-lg-3 mt-5">
                            ...
                            <div className="form-group">
                                ...
                                >
                                    ...
                                    <option value="This product is currently out of stock; if you have already paid,we will reimburse your money within 24 hours.I apologize for the trouble this has caused.">Out Of Stock</option>
                                </select>
                            </div>
                            <button 
                                disabled={loading}
